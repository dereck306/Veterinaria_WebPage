...
//es como se le conocce auna interface ao aun lugar donde 

app.use('/api', require('./routes/usuarios.route'));
app.use('/api', require('./routes/citasMedicas.route'));
app.use('/api', require('./routes/route-calificacion-mascota'));
app.use('/api', require('./routes/route-metodo-pago'));
app.use('/api', require('./routes/mascotas.route'));
app.use('/api', require('./routes/habitacion.route'));
app.use('/api', require('./routes/observaciones.route'));
app.use('/api', require('./routes/mascotas.route'));